...
// ════════════════════════════════════════════════
//  🔑 TU API KEY DE MISTRAL (YA INCLUIDA)
// ════════════════════════════════════════════════
...
app.post('/api/chat', async (req, res) => {
    ...
    try {
        ...
        let mensajeUsuario = "";
        if (imagen) {
            mensajeUsuario = `[IMAGEN ENVIADA: captura de pantalla de un chat de WhatsApp/Instagram/Tinder. Lee el texto de la conversación y genera la respuesta perfecta.] Contexto adicional: ${contexto || "Ninguno"}`;
        } else {
